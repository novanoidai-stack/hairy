    ...
    <View style={[s.container, { backgroundColor: c.bg, paddingBottom: insets.bottom + spacing.lg }]}>
      <ScrollView contentContainerStyle={{ padding: spacing.lg, gap: spacing.lg }}>
          ...
          <View style={{ gap: spacing.sm }}>
            ...
            <View style={s.estadosGrid}>
              {ESTADOS.filter((e) => e.key !== 'cancelada' && e.key !== cita.estado).map((e) => (
                ...
                >
                  <TText style={[s.estadoBtnText, { color: e.color }]}>{e.label}</TText>
                </TouchableOpacity>
              ))}
            </View>
          </View>
        ...
        >
          ...
          <TText style={s.cancelBtnText}>Borrar cita</TText>
        </TouchableOpacity>
      </ScrollView>
      ...
      {mostrarnDialogoEliminar && (
        <View style={s.dialogOverlay}>
          <View style={[s.dialog, { backgroundColor: c.surface, borderColor: c.border }]}>
            <TText style={[s.dialogTitle, { color: c.text }]}>Borrar cita</TText>
            ...
            <View style={s.dialogButtons}>
              <TouchableOpacity
                ...
                disabled={actualizando}
              >
                <TText style={[s.dialogBtnText, { color: c.text }]}>Cancelar</TText>
              </TouchableOpacity>
              <TouchableOpacity
