// Icono SVG por nombre, extraido del monolito de agenda para poder\n// compartirlo con las vistas de semana/mes. Misma implementacion, tal cual.
export const Icon = ({ name, size = 24, color = "#f8fafc" }: any) => {
  const icons: any = {
