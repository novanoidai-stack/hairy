...
(function () {
  ...
  var DICTS = {
    es: {
      ...
      nav_directorio: 'Reservar en un salón',
      cbar_pregunta: '¿Buscas peluquería?', cbar_accion: 'Reserva cita en un salón cerca de ti', cbar_accion_corta: 'Reserva cita',
    ...
    en: {
      ...
      nav_directorio: 'Book at a salon',
      cbar_pregunta: 'Looking for a salon?', cbar_accion: 'Book an appointment near you', cbar_accion_corta: 'Book now',
    ...
    fr: {
      ...
      nav_contacto: 'Contact',
      nav_directorio: 'Réserver en salon',
      cbar_pregunta: 'Vous cherchez un salon ?', cbar_accion: 'Réservez près de chez vous', cbar_accion_corta: 'Réserver',
    ...
    de: {
      ...
      nav_directorio: 'Salon buchen',
      cbar_pregunta: 'Auf Salonsuche?', cbar_accion: 'Termin in deiner Nähe buchen', cbar_accion_corta: 'Termin buchen',
    ...
    it: {
      ...
      nav_directorio: 'Prenota in salone',
      cbar_pregunta: 'Cerchi un parrucchiere?', cbar_accion: 'Prenota vicino a te', cbar_accion_corta: 'Prenota ora',
    ...
    pt: {
      ...
      nav_directorio: 'Reservar num salão',
      cbar_pregunta: 'Procuras cabeleireiro?', cbar_accion: 'Marca perto de ti', cbar_accion_corta: 'Marcar já',
    ...
    ca: {
      ...
      nav_directorio: 'Reservar en un saló',
      cbar_pregunta: 'Busques perruqueria?', cbar_accion: 'Reserva a prop teu', cbar_accion_corta: 'Reserva cita',
  ...
  function applyLang(code) {
    ...
    // Sincronizar con Google Translate programático
  ...
  function buildSwitcher() {
    ...
    css.textContent = ''
      ...
      + 'iframe.skiptranslate, .goog-te-banner-frame, #goog-gt-tt, .goog-te-balloon-frame, .goog-te-banner{display:none !important;visibility:hidden !important}'
      + 'body{top:0px !important}'
      + '.goog-tooltip, .goog-tooltip:hover{display:none !important;opacity:0 !important;visibility:hidden !important}'
  ...
  function loadGoogleTranslate() {
    ...
    window.googleTranslateElementInit = function () {
      new google.translate.TranslateElement({
        pageLanguage: 'es',
        includedLanguages: 'es,en,fr,de,it,pt,ca',
